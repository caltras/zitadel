  ...
  clsx(
    {
      ...
      "disabled:border-none disabled:bg-none disabled:bg-gray-200 disabled:text-gray-400 disabled:shadow-none disabled:cursor-not-allowed disabled:dark:bg-gray-800 disabled:dark:text-gray-500":
